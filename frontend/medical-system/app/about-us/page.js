  ...
  return (
    <div className="w-full">
      ...
      <div className="intro-section  ">
        ...
        <p>
          Our medical appointment system enables seamless communication between
          patients and doctors. The platform ensures that after an appointment
          is completed, the connection between the patient and doctor remains
          strong, facilitating ongoing interaction.
        </p>
        ...
        <p>
          ...
          enhances transparency and ensures that critical information is shared
          promptly.
          <p>
